...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--result-dir", type=Path, default=Path("remote_results/hermes_clean_split"))
    parser.add_argument("--graph-baseline-dir", type=Path, default=Path("remote_results/graph_baselines_clean_split"))
    parser.add_argument("--standard-baseline-dir", type=Path, default=Path("remote_results/standard_baselines_clean_split"))
    parser.add_argument("--ablation-dir", type=Path, default=Path("remote_results/hermes_ablation_clean_split"))
    parser.add_argument("--output-dir", type=Path, default=Path("paper/hermes_manuscript/evidence"))
